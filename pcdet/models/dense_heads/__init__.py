...
from .anchor_head_single import AnchorHeadSingleERPN
from .anchor_head_kl import AnchorHeadKL
from .anchor_head_iou import AnchorHeadIoU
from .anchor_head_kl_label import (
    AnchorHeadKLLabel,
    AnchorHeadKLLabelIoU,
    AnchorHeadKLLabelIoUGuide,
)
...
__all__ = {
    ...
    "AnchorHeadTemplateERPN": AnchorHeadTemplateERPN,
    "AnchorHeadSingle": AnchorHeadSingle,
    "AnchorHeadSingleERPN": AnchorHeadSingleERPN,
